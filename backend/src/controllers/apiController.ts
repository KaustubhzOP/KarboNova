...
export class ApiController {
  public static getDashboardSummary(req: Request, res: Response) {
    res.json({
  ...
  public static getEvidence(req: Request, res: Response) {
    res.json([
  ...
  public static calculateOpportunity(req: Request, res: Response) {
